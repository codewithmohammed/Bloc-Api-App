...
class Patch extends StatelessWidget {
  const Patch({super.key, required this.productsModel});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<PatchBloc, PatchState>(
      ...
      child: Scaffold(
          appBar: AppBar(
            title: const Text('Patch Product'),
          ),
                  ...
                  Stack(
                    children: [
                      Container(
                        ...
                        child: BlocBuilder<PatchBloc, PatchState>(
                          builder: (context, state) {
                            if (state is PatchInitial) {
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              if (formKey.currentState!.validate()) {
                                ...
                                context.read<PatchBloc>().add(PatchTheProduct(
                                    postModel: PostModel(
